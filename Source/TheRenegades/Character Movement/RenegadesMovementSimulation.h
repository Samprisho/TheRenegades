...
struct THERENEGADES_API FCharacterMotionInputCmd
{
...
struct THERENEGADES_API FFloorTestResult
{
	/**
...
struct THERENEGADES_API FCharacterMotionSyncState
{
...
struct NETWORKPREDICTIONEXTRAS_API FCharacterMotionAuxState
{
	...
	void Interpolate(const FCharacterMotionAuxState* From, const FCharacterMotionAuxState* To, float PCT)
	{
		...
		// something = FMath::Lerp(From->something, To->something, PCT);
...
class THERENEGADES_API FRenegadesMovementSimulation : public FBaseMovementSimulation
{
public:
